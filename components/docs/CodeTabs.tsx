...
import type { CodeExample } from "@/lib/docs/code-examples";
...
// Language-specific syntax highlighting classes (simplified)
          ...
          >
            ...
            <pre
              className={cn(
                ...
                languageColors[example.language] || "language-plaintext"
              )}
            >
