...
const steps = [
  ...
  },
  {
    ...
    description: "Per-second, hourly, daily, monthly limits verified concurrently",
    icon: Gauge,
  },
  {
    id: 4,
  ...
  },
  {
    ...
    description: "Metrics recorded via SSE, response streamed back in real-time",
    icon: Activity,
  },
];
          ...
          <div className="relative">
            ...
            <div className="flex items-center justify-center gap-6 flex-wrap">
              ...
              >
                ...
                <span className="text-xs text-muted-foreground">&lt;2ms processing</span>
              </motion.div>
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <span className="text-xs text-muted-foreground">Upstream API</span>
              </div>
            </div>
            ...
            <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-2xl mx-auto">
              ...
              <div className="text-center p-3 rounded-lg bg-background/50 border">
                <div className="text-xl font-bold text-foreground mb-1">&lt;2ms</div>
                <div className="text-xs text-muted-foreground">Latency</div>
              </div>
              <div className="text-center p-3 rounded-lg bg-background/50 border">
                <div className="text-xl font-bold text-foreground mb-1">100k+</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start max-w-6xl mx-auto">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              uses Go's concurrency primitives to check all tiers in parallel.
              No database locks. No bottlenecks. Just pure concurrency that
              scales horizontally.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              When limits are hit, requests don't fail — they{" "}
              <strong className="text-foreground">queue intelligently</strong>{" "}
              using FIFO with configurable timeouts. Your API stays responsive
            ...
            {[
              {
                ...
                description: "Every request verified before touching rate limits",
              },
              {
                icon: Gauge,
                title: "Concurrent Rate Checks",
                description: "4 time-scale limits verified in parallel",
              },
              {
                icon: Timer,
                title: "Intelligent Queuing",
                description: "FIFO queue prevents 429s, respects upstream limits",
              },
              {
                icon: GitMerge,
                title: "Auto-Discovery",
                description: "Learns API limits from 429 responses automatically",
              },
              {
                icon: BarChart3,
              ...
              },
              {
                icon: ArrowRightLeft,
                title: "Transparent Proxy",
                description: "Drop-in replacement, no code changes needed",
              },
            ].map((feature, i) => (
              <motion.div
                key={feature.title}
