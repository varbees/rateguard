...
export function NoAPIsConfigured({
  ...
  return (
    <EmptyState
      ...
      description="Configure rate limits and get your proxy URL in seconds. Protect your APIs with middleware-first rate limiting and analytics."
      action={{
...
export function NoStreamingData({ onConfigure }: NoStreamingDataProps) {
  return (
    <EmptyState
      ...
      description="Start using streaming endpoints to see real-time metrics, usage analysis, and performance data here."
      action={{
