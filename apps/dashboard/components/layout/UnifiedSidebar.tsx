...
const primaryNavItems: NavItem[] = [
  {
    ...
    icon: LayoutGrid,
    description: "System health, traffic, and active incidents",
  },
  {
    title: "Routes",
    href: "/dashboard/apis",
    icon: Server,
    description: "Manage the routes RateGuard protects",
    children: [
      {
        title: "Create Route",
  ...
  },
  {
    ...
    icon: ShieldCheck,
    description: "Rate limits, cost guardrails, and protection controls",
  },
  {
    title: "Realtime",
    href: "/dashboard/streaming",
    icon: Activity,
    description: "Live streaming metrics and operator signals",
  },
  {
    title: "Events",
    href: "/dashboard/events",
    icon: Zap,
    description: "Event stream, alerts, and fanout activity",
  },
  {
    title: "Webhooks",
  ...
  },
  {
    ...
    href: "/docs",
    icon: BookOpen,
    description: "Guides, concepts, and API reference",
  },
  {
    title: "Settings",
    href: "/dashboard/account",
    icon: Settings,
    description: "Profile, security, and runtime defaults",
  },
];
...
const secondaryNavItems: NavItem[] = [
  {
    ...
    icon: Key,
    description: "Rotate and manage access credentials",
  },
];
        ...
        {!isSidebarCollapsed && isAuthenticated && (
          <div className="px-2 py-2 mb-2 rounded-md bg-gradient-to-r from-primary/20 to-purple-500/20 border border-primary/10">
            <div className="flex items-center justify-between">
              <span className="text-xs font-medium text-primary">Cost Guardrails</span>
              <Link
                href="/dashboard/budget"
