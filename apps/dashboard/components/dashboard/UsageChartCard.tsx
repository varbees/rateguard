 ...
 * 
 * Real-time usage chart that streams data points via WebSocket
 * with HTTP fallback when realtime is unavailable.
 */
          ...
          <div className="flex items-center gap-2">
            <div>
              ...
              <CardDescription>
                ...
                {totalCost > 0 && <> • ${totalCost.toFixed(2)} estimated cost</>}
              </CardDescription>
            </div>
            {hasAccess && (
