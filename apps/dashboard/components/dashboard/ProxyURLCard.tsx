    ...
    defer resp.Body.Close()
              ...
              <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-900/50">
                <p className="text-sm text-blue-800 dark:text-blue-200">
                  <strong>Operational Note:</strong> Replace <code className="px-1 py-0.5 bg-blue-100 dark:bg-blue-900/40 rounded">{targetUrl}</code> with <code className="px-1 py-0.5 bg-blue-100 dark:bg-blue-900/40 rounded">{proxyUrl}</code> in your existing code. No other changes are needed.
                </p>
              </div>
            </DialogContent>
          </Dialog>
