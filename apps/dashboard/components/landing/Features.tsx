...
const features = [
  {
    ...
    description:
      "Embed RateGuard in-process or use the proxy path when you need it.",
    icon: Shield,
    joke: "Less glue code. More request handling.",
  },
  {
  ...
  {
    title: "Unified Usage Accounting",
    description:
      "Track request counts and token usage together without splitting the operational view.",
    icon: Globe,
    joke: "One dashboard, one mental model.",
    highlight: true,
  },
  {
  ...
  {
    title: "Policy Presets & Guardrails",
    description: "Strict preset-based limits with transparent enforcement and review paths.",
    icon: AlertTriangle,
      ...
      <div className="container max-w-7xl mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-muted-foreground md:text-xl max-w-3xl mx-auto">
            We stripped away the noise and kept the stuff that actually
            matters. No fluff. No vaporware. Just battle-tested features that
            work.
          </p>
        </div>
