...
const faqs = [
  ...
  },
  {
    ...
    answer: "Yes! The control plane is designed for self-hosted deployments.",
    category: "Technical",
  },
  {
  ...
  },
  {
    ...
    answer:
      "We only store metadata (counts, keys). Your actual request payloads are not stored unless you explicitly turn on debug capture for troubleshooting.",
    category: "Security",
  },
  {
