...
export const metadata: Metadata = {
  ...
  description: "Terms of Service for RateGuard middleware and control plane",
};
    ...
    <div className="animate-fade-in-up">
      ...
      <div className="space-y-12">
        ...
        <section>
          ...
          <p>
            RateGuard provides middleware, a self-hosted control plane, and
            observability tooling for developers. The Service is designed to run
            alongside your application without forcing traffic rerouting.
          </p>
        </section>
