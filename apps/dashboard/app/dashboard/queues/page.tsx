...
import type { APIQueue, QueuedRequest, QueueStats, QueueConfig } from "@/lib/api";
import {
  useQueueStats,
  useActiveQueues,
  useQueueConfig,
...
export default function QueueDashboardPage() {
  ...
  const queuedByApi: APIQueue[] = queueStats?.queued_by_api ?? [];
