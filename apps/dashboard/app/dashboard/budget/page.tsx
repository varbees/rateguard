...
export default function BudgetPage() {
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        title: "Cost guardrails saved",
        description: "Your cost guardrail configuration has been updated.",
      });
    },
    onError: (error: any) => {
      toast({
        title: "Failed to save cost guardrails",
    ...
    <div className="min-h-screen bg-background">
      <div className="container max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Cost Guardrails</h1>
            <p className="text-muted-foreground mt-1">
              Manage spend limits, alerts, and optimization signals
            </p>
          </div>
