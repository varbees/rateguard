    ...
    <div className="space-y-8">
      ...
      >
        <TabsList className="inline-flex h-12 items-center justify-start rounded-lg bg-muted p-1.5 text-muted-foreground w-full overflow-x-auto">
          ...
          <TabsTrigger value="guardrails" className="gap-2 px-4">
        ...
        <TabsContent value="guardrails" className="space-y-6">
          <Card className="bg-card border-border">
            <CardHeader>
              <CardTitle className="text-foreground">Cost Guardrails</CardTitle>
              <CardDescription>
                Monitor live usage and review the active policy preset
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-3">
                ...
                <p className="text-xs text-muted-foreground">
                  Guardrails are enforced from the active preset and reflected in live usage.
                </p>
              </div>
              ...
              <div className="space-y-3">
                <h4 className="font-semibold text-foreground">Review Actions</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 bg-accent border border-slate-700 rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                      Review rate limits, token budgets, and webhook policies.
                    </p>
                    <Button className="w-full" asChild>
                      <a href="/dashboard/budget">Review Guardrails</a>
                    </Button>
                  </div>
                  <div className="p-4 bg-accent border border-slate-700 rounded-lg">
                    <h5 className="font-semibold text-foreground mb-2">
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                      {dashboardStats
                        ? `${dashboardStats.stats.active_apis} APIs protected right now`
                        : "Loading current API count..."}
                    </p>
                    <Button className="w-full" variant="outline" asChild>
                      <a href="/dashboard/apis">Open APIs</a>
                    </Button>
                  </div>
                </div>
              </div>
          ...
          <Card className="bg-card border-border">
            <CardHeader>
              ...
              <CardDescription>
                Account-level controls and API key management
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-accent border border-slate-700 rounded-lg">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-8 bg-linear-to-r from-blue-500 to-cyan-500 rounded flex items-center justify-center text-foreground text-xs font-bold">
                    API
                  </div>
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      No payment method is required for the OSS dashboard.
                    </p>
                  </div>
                </div>
