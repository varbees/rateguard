...
import { BACKEND_LIMITS } from '@/components/dashboard/wizard/RateLimitSetup';
            ...
            <CardContent className="space-y-6">
              <div className="space-y-3">
                ...
                <Slider
                  ...
                  min={1}
                  max={BACKEND_LIMITS.ratePerSecond.max}
                  step={1}
                />
              </div>
              ...
              <div className="space-y-3">
                ...
                <Slider
                  ...
                  min={perSecond}
                  max={BACKEND_LIMITS.burstSize.max}
                  step={1}
                />
              </div>
              ...
              <div className="space-y-3">
                ...
                <Slider
                  ...
                  min={0}
                  max={BACKEND_LIMITS.ratePerHour.max}
                  step={100}
                />
              </div>
              ...
              <div className="space-y-3">
                ...
                <Slider
                  ...
                  min={0}
                  max={BACKEND_LIMITS.ratePerDay.max}
                  step={1000}
                />
              </div>
              ...
              <div className="space-y-3">
                ...
                <Slider
                  ...
                  min={0}
                  max={BACKEND_LIMITS.ratePerMonth.max}
                  step={10000}
                />
              </div>
            </CardContent>
