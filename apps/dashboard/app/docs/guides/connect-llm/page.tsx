...
const openai = new OpenAI({
  ...
  baseURL: '${DOCS_PROXY_BASE_URL}/openai/v1', // The magic happens here
  defaultHeaders: {
...
client = OpenAI(
    ...
    base_url="${DOCS_PROXY_BASE_URL}/openai/v1", # The magic happens here
...
const anthropic = new Anthropic({
  ...
  baseURL: '${DOCS_PROXY_BASE_URL}/anthropic', // Note: No /v1 here for Anthropic SDK usually
  defaultHeaders: {
    'X-RG-Key': process.env.RATEGUARD_API_KEY
  }
});
...
const message = await anthropic.messages.create({
  ...
  model: 'claude-3-opus-20240229',
              ...
              },
              {
                label: "cURL",
                language: "bash",
                code: `curl ${DOCS_PROXY_BASE_URL}/anthropic/v1/messages \\
