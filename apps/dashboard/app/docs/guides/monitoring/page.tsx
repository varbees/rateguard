  ...
  return (
    <div className="min-h-screen bg-background space-y-12 max-w-5xl mx-auto">
      ...
      <div className="space-y-12 px-4">
          ...
          <div className="space-y-4">
            <div className="p-4 border rounded-lg bg-card">
              ...
              <p className="text-muted-foreground">
                ...
                Crucial for preventing surprise usage costs from your providers.
              </p>
            </div>
        ...
        <Callout type="default" title="Advanced Alerting">
          Advanced alerting (Slack integration and custom webhooks) is available through guardrail configuration.
        </Callout>
      </div>
    </div>
  );
