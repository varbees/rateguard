...
export const metadata: Metadata = {
  ...
  description: "Get up and running with RateGuard in less than 5 minutes.",
};
        ...
        <div className="flex items-start gap-4 mb-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Wrap your first API request with RateGuard in less than a minute.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-12 px-4">
        ...
        <section className="space-y-6">
          ...
          <p className="text-muted-foreground text-lg">
            Replace the base URL with RateGuard&apos;s proxy endpoint. If you&apos;re embedding middleware directly, use the SDK path instead.
          </p>
