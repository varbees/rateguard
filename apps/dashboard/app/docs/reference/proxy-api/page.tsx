...
export const metadata: Metadata = {
  ...
  description: "Technical reference for the RateGuard proxy path.",
};
        ...
        <div className="flex items-start gap-4 mb-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              The nuts and bolts of the proxy path for existing clients.
            </p>
          </div>
        </div>
      </div>
        ...
        <section className="space-y-6">
          ...
          <Card className="bg-muted/50">
            <CardContent className="pt-6 font-mono text-sm">
              <p className="text-primary font-bold">{DOCS_PROXY_BASE_URL}</p>
            </CardContent>
          </Card>
        </section>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-muted-foreground mb-4">
                Forwards proxy requests to the specified provider.
              </p>
