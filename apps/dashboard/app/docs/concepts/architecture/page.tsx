      ...
      <div className="border-b bg-muted/30 pb-8 pt-12 rounded-xl px-8">
        <div className="flex items-start gap-4 mb-6">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed">
              How we handle millions of requests without breaking a sweat or forcing you into a proxy-first design.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-12 px-4">
        ...
        <section className="space-y-6">
          ...
          <p className="text-lg text-muted-foreground">
            ...
            We use a combination of middleware entry points, a high-performance Go backend, and Redis for state management.
          </p>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Requests enter through middleware or the proxy path. We verify API keys and check local caches for rate limits.
        ...
        <section className="space-y-6">
          ...
          <p className="text-lg text-muted-foreground">
            We use a dual concurrency model to balance performance and reliability.
          </p>
          
          <div className="space-y-4">
            <div className="p-4 border rounded-lg bg-card">
              <h3 className="font-bold mb-2">1. The Fast Lane (Middleware)</h3>
              <p className="text-muted-foreground">
                The middleware path is optimized for raw speed. It uses unbounded goroutines to handle as many requests as possible.
