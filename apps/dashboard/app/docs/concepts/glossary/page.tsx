    ...
    <div className="min-h-screen bg-background space-y-12 max-w-5xl mx-auto">
      ...
      <div className="space-y-12 px-4">
        <Accordion type="single" collapsible className="w-full">
          ...
          <AccordionItem value="usage-accounting">
            <AccordionTrigger>Usage Accounting</AccordionTrigger>
            <AccordionContent>
              A unified accounting model that tracks both request counts and token usage in the same operational view.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="edge-proxy">
            ...
            <AccordionContent>
              A deployment mode that sits close to the user and forwards requests to the destination. Middleware is the primary path, and proxy mode is the fallback for clients that need a routed entrypoint.
            </AccordionContent>
          </AccordionItem>
