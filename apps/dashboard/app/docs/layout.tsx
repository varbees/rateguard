...
const docsNav = [
  ...
  },
  {
    title: "Guides",
    items: [
      { title: "Setup & First Middleware", href: "/docs/guides/setup", icon: Zap },
  ...
  },
  {
    title: "Features",
    items: [
      { title: "Policy Presets & Guardrails", href: "/docs/features/plan-enforcement", icon: Shield },
  ...
  },
  {
    title: "Reference",
    items: [
      { title: "Runtime API", href: "/docs/reference/proxy-api", icon: FileText },
