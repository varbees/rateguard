      ...
      <div className="space-y-12 px-4">
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="contact">
            ...
            <AccordionContent>
              You can email us at <a href="mailto:support@rateguard.io" className="text-primary hover:underline">support@rateguard.io</a>. The dashboard also includes built-in links to docs and operational guidance.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="response-time">
            ...
            <AccordionContent>
              Response times depend on the support channel and severity of the issue. For critical operational problems, include the request ID and a clear reproduction path.
            </AccordionContent>
          </AccordionItem>
