      ...
      <div className="space-y-12 px-4">
        <Accordion type="single" collapsible className="w-full">
          ...
          <AccordionItem value="compliance">
            ...
            <AccordionContent>
              Compliance depends on your deployment, controls, and regulatory requirements. RateGuard gives you the security primitives and observability; your team should validate the full environment for any regulated use case.
            </AccordionContent>
          </AccordionItem>
