            ...
            <Card className="border-2">
              <CardHeader className="pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-sm">API key auth</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <p className="text-xs text-muted-foreground">
                  API keys secure server-to-server requests to the current gateway
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2">
              <CardHeader className="pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-sm">Preset guardrails</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <p className="text-xs text-muted-foreground">
                  Preset-driven request limits, queueing, and token budgets
                </p>
              </CardContent>
            </Card>
      ...
      <div className="container max-w-5xl mx-auto px-6 py-12">
        ...
        <section className="mb-16">
          ...
          <Callout type="default" title="API Base URL">
            All API requests should be made to your backend base URL. In local
            development the default is{" "}
            <code className="font-mono text-sm">http://localhost:8008</code>.
          </Callout>
        </section>
        ...
        <section className="mb-16">
          ...
          <p className="text-muted-foreground mb-6 leading-relaxed">
            RateGuard implements Redis-backed policy enforcement and realtime
            rate-limit visibility. Monitor your policy status programmatically.
          </p>
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="text-sm">Default Presets</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-2 text-xs">
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">dev:</span>
                    <Badge variant="secondary">lowest friction</Badge>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <Badge variant="secondary">higher limits</Badge>
                  </div>
                </div>
              </CardContent>
            </Card>
