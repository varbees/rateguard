...
import { API_BASE_URL } from "@/lib/docs/api-specs";
        ...
        <div className="container max-w-5xl mx-auto px-6 py-16">
          <div className="flex items-start justify-between mb-6">
            ...
            <div className="flex flex-col gap-2 items-end ml-4">
              <Badge variant="secondary">SSE-enabled</Badge>
              <span className="text-xs text-muted-foreground">
                Streaming is available wherever the event stream is enabled.
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-8">
            {[
              ...
              },
              {
                ...
                desc: "Track requests, latency, and patterns",
              },
              {
                icon: Clock,
                color: "text-chart-3",
        ...
        <section>
          ...
          <Callout type="default" title="Three-Layer Monitoring System">
            ...
            <ol className="mt-2 ml-4 space-y-1">
              ...
              <li><strong>3. Historical Analytics</strong> - Usage trends and operational patterns</li>
            </ol>
          </Callout>
        </section>
...
const eventSource = new EventSource(
  '${API_BASE_URL}/dashboard/stats/streaming',
  { withCredentials: true }
);
    ...
    <div className="space-y-2">
      {alerts.map((alert) => (
        ...
        <section>
          ...
          <p className="text-muted-foreground mb-6 leading-relaxed">
            Track API usage patterns and performance metrics over time.
...
func (c *CostEstimator) EstimateMonthlyCost(
    ...
    // Usage accounting: base + (requests/1000 * rate)
    baseCost := 0.0
          ...
          <div className="space-y-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Get usage cost estimates and breakdown
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground mb-2">
                  Returns estimated monthly usage costs broken down by API, helping
                  you understand the operational footprint.
                </p>
                <Badge>Authenticated</Badge>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <ul className="space-y-2 text-sm">
                  {[
                    ...
                    "Review usage cost trends monthly",
