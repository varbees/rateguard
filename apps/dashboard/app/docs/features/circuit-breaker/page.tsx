...
export const metadata: Metadata = {
  ...
  description:
    "Use RateGuard's circuit breaker to stop failing upstreams from consuming the rest of the request budget.",
};
        ...
        <div className="flex items-start gap-4 mb-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              When an upstream starts failing, the circuit breaker stops the
              blast radius and gives the service time to recover.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-12 px-4">
        ...
        <section className="space-y-6">
          ...
          <p className="text-muted-foreground text-lg">
            ...
            for a short window and try again once the service has had time to recover.
          </p>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <Card className="border-l-4 border-l-green-500">
              ...
              <CardContent className="text-sm text-muted-foreground">
                Traffic flows normally and requests proceed without interruption.
              </CardContent>
            </Card>
            <Card className="border-l-4 border-l-red-500">
              ...
              <CardContent className="text-sm text-muted-foreground">
                Too many errors. We stop forwarding requests until the upstream stabilizes.
              </CardContent>
            </Card>
            <Card className="border-l-4 border-l-yellow-500">
              ...
              <CardContent className="text-sm text-muted-foreground">
                We let a few requests through to check recovery before reopening fully.
              </CardContent>
            </Card>
          </div>
        </section>
        ...
        <section className="space-y-6">
          ...
          <p className="text-muted-foreground text-lg">
            Tune the sensitivity to match the reliability profile of the upstream service.
          </p>
  ...
  "circuit_breaker": {
    ...
    "min_requests": 10
        ...
        <Callout type="danger" title="Warning">
          Set the threshold too low and you will block healthy traffic. Tune with
          measured production traffic, not guesses.
        </Callout>
        ...
        <section className="space-y-6">
          ...
          <p className="text-muted-foreground text-lg">
            ...
            so clients can back off cleanly while the upstream recovers.
          </p>
