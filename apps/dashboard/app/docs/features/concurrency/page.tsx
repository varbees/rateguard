...
export const metadata: Metadata = {
  title: "Concurrency Architecture | RateGuard Documentation",
  description:
    "Learn how RateGuard balances middleware throughput with bounded aggregation for optimal performance.",
};
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="text-xl text-muted-foreground mt-2">
              Intelligent concurrency model that balances middleware throughput
              with resource protection using both unbounded and bounded strategies.
            </p>
          </div>
        </div>
      </div>
      ...
      <Callout title="Production Architecture" type="default">
        RateGuard uses a dual concurrency model: unbounded goroutines for
        request handling and bounded worker pools for heavier aggregation.
      </Callout>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="border-2 border-primary/30 rounded-lg p-6 bg-primary/5">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
              <h3 className="text-xl font-bold">Unbounded Request Handling</h3>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Simple request handling, rate limit checks, and auth verification
                </p>
              </div>
              <div>
...
AGG_WORKER_POOL_QUEUE_SIZE=500`}
        ...
        <Callout title="Best Practices" type="warning">
          <ul className="list-disc pl-4 space-y-1 mt-2">
            ...
            <li>
              <strong>Use unbounded for simple request handling:</strong> Reserve
              the bounded path for heavy operations
            </li>
            <li>
