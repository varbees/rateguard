...
export const metadata: Metadata = {
  ...
  description: "Track token usage and usage cost visibility for LLM APIs.",
};
    ...
    <div className="min-h-screen bg-background space-y-12 max-w-5xl mx-auto">
        ...
        <div className="flex items-start gap-4 mb-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Count tokens once, keep the rest of the workflow readable.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-12 px-4">
        ...
        <section className="space-y-6">
          ...
          <p className="text-lg text-muted-foreground">
            We use published model rates and your token counts to show estimated usage cost for major providers.
            The result is operational visibility, not a payments workflow.
          </p>
          
          <Callout type="default" title="Operational Note">
            These are estimates. Actual rates can vary because of rounding, discounts, or custom agreements.
          </Callout>
        </section>
