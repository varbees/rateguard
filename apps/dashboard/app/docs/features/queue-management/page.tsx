      ...
      <div className="space-y-12 px-4">
        ...
        <section className="space-y-6">
          ...
          <p className="text-muted-foreground text-lg">
            Not all requests are created equal. Some are guardrail-triggered, and some are background work that can wait a little longer.
          </p>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <Card className="border-t-4 border-t-green-500">
              ...
              <CardContent className="text-sm text-muted-foreground">
                Critical webhooks and urgent events. These skip the line.
              </CardContent>
            </Card>
            ...
            <Card className="border-t-4 border-t-gray-500">
              ...
              <CardContent className="text-sm text-muted-foreground">
                Background jobs and batch analytics. These wait until the queue is calm.
              </CardContent>
            </Card>
          </div>
        </section>
