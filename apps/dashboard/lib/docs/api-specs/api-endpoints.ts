  ...
  responses: [
    {
      ...
      example: {
        ...
        rate_limit_per_day: 10000,
        enabled: true,
        proxy_url: `${API_BASE_URL}/proxy/github-api`,
    ...
    },
    {
      ...
      example: {
        ...
        message: "Maximum number of APIs reached for your policy preset",
        timestamp: "2024-01-15T10:30:00Z",
      },
    },
    {
...
puts "Rate limit remaining: #{remaining}"`,
  ...
  errorScenarios: [
    ...
    },
    {
      ...
      error: "API limit reached",
      description:
        "Maximum number of APIs reached for your current policy preset",
      solution: "Adjust your preset or delete unused APIs",
    },
    {
      status: 409,
      error: "API configuration already exists",
  ...
  responses: [
    {
      ...
      example: [
        ...
        },
        {
          ...
          burst_size: 10,
          enabled: true,
          proxy_url: `${API_BASE_URL}/proxy/weather-api`,
