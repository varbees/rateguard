...
export const AUTH_SIGNUP: EndpointSpec = {
  ...
  title: "Sign Up",
  description:
    "Create a new user account with email and password. The backend assigns the default policy preset unless one is supplied.",
  ...
  requestBody: {
    ...
    schema: {
      ...
      preset:
        "string (optional) - policy preset. Backend normalizes to a policy preset and defaults to dev when omitted.",
    },
    example: {
