...
import { API_BASE_URL } from "./api-specs";
...
export const paymentGatewayExamples: ApiExample = {
  title: "Commercial Checkout Example",
  description: "Create a checkout session through the billing API when you need a hosted checkout flow.",
  examples: [
    {
      language: "curl",
      label: "cURL",
...
export const planEnforcementExamples: ApiExample = {
  title: "Check Policy Preset",
  description: "Verify whether a policy preset allows a specific feature",
  examples: [
    {
      language: "curl",
      label: "cURL",
  ...
  if (!allowed) {
    console.log('Policy adjustment required:', upgrade_required);
  }
  return allowed;
};`,
    },
