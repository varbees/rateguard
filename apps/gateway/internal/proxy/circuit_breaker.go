...
func NewCircuitBreakerConfigFromSettings(maxFailures, timeoutSeconds, maxConcurrentHalfOpen, successThreshold int) CircuitBreakerConfig {
	return CircuitBreakerConfig{
...
func (cb *CircuitBreaker) toOpen() {
	...
	logger.Error("Circuit breaker OPENED",
		...
		zap.String("api_name", cb.apiName),
		zap.Int32("consecutive_failures", cb.consecutiveFailures.Load()),
