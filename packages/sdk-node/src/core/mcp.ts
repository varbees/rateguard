  ...
  const listLimits = async (args: Record<string, unknown>): Promise<Record<string, unknown>> => {
    ...
    return {
      ...
      preset: {
        ...
        burst: runtime.config.rateLimit.burst,
        token_budget_per_hour: runtime.config.tokenBudget.hourLimit,
        token_budget_per_day: runtime.config.tokenBudget.dayLimit,
        token_budget_per_month: runtime.config.tokenBudget.monthLimit,
        token_budget_mode: runtime.config.tokenBudget.mode,
      },
