    ...
    def list_limits(args: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "preset": {
                ...
                "token_budget_per_hour": runtime.config.token_budget.hour_limit,
                "token_budget_per_day": runtime.config.token_budget.day_limit,
                "token_budget_per_month": runtime.config.token_budget.month_limit,
                "token_budget_mode": runtime.config.token_budget.mode,
            },
